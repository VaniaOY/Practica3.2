...
public class MainActivity extends Activity implements OnSeekBarChangeListener,
	...
	String correo, contraseña, telefono, motivo, antes;
	Bundle recibe;
	TextView propi;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getIntent().getExtras()!=null){
			...
			contraseña = recibe.getString("contraseña");
			telefono = recibe.getString("telefono");
			motivo = recibe.getString("motivo");
			antes = recibe.getString("visitaAnterior");
			propi = (TextView) findViewById(R.id.textViewPropiedades);
			propi.setText("MI INFORMACION: \n" +
					"Correo: "+ correo +"\n" +
					"Contraseña: "+ contraseña +"\n" +
					"Telefono: "+ telefono + "\n" +
					"Ultimo motivo de mi ultimo/proxima visita: "+motivo+"\n" +
					antes+" he visitado este lugar");
		}
